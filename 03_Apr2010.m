...
%
%    /home/space/Desktop/Sadaf/Events/events/WLRT_2010-04-03_ALL.rt
%
% To extend the code to different selected data or a different text file,
% generate a function instead of a script.

% Auto-generated by MATLAB on 2017/12/31 13:38:53

%% Initialize variables.
filename = '/home/space/Desktop/Sadaf/Events data/events/WLRT_2010-04-03_ALL.rt';
startRow = 2;
...
AR = cell2mat(rawNumericColumns(:, 5));
...
clearvars filename Date LON LAT ROT GLEL OSRA NGE NBP startRow formatSpec fileID dataArray ans raw col numericData rawData row regexstr result numbers invalidThousandsSeparator thousandsRegExp me rawNumericColumns rawCellColumns;
...
m0 = exp(15.1);        %true CME mass
delm = exp(14.6);      %mass increase with height 
hocc = 3.46; %radius of occultation
...
plot(ACC_smooth)
 ...
 %% C_d calculation
Mcme=Mcme1(2:46,:);   %mass of cme
Acme=Acme1(2:46,:);   %making the dim same
n_H=n_H1(2:46,:);
