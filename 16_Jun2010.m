...
%
%    /home/space/Desktop/Sadaf/Events/events/WLRT_2010-06-16_ALL.rt
%
% To extend the code to different selected data or a different text file,
% generate a function instead of a script.

% Auto-generated by MATLAB on 2018/01/09 09:51:22

%% Initialize variables.
filename = '/home/space/Desktop/Sadaf/Events data/events/WLRT_2010-06-16_ALL.rt';
startRow = 2;

%% Read columns of data as strings:
% For more information, see the TEXTSCAN documentation.
formatSpec = '%11s%9s%8s%8s%8s%8s%8s%9s%4s%5s%4s%s%[^\n\r]';
...
LEL = cell2mat(rawNumericColumns(:, 7));
OSRA = cell2mat(rawNumericColumns(:, 8));
NGE = cell2mat(rawNumericColumns(:, 9));
NBP = cell2mat(rawNumericColumns(:, 10));

%% Clear temporary variables
clearvars filename startRow Date LON LAT ROT LEL OSRA NGE NBP formatSpec fileID dataArray ans raw col numericData rawData row regexstr result numbers invalidThousandsSeparator thousandsRegExp me rawNumericColumns rawCellColumns;
...
m0 = exp(14.9);        %true CME mass
delm = exp(14.1);      %mass increase with height 
hocc = 4.37; %radius of occultation
...
plot(ACC_smooth)
 ...
 %% C_d calculation
Mcme=Mcme1(2:85,:);   %mass of cme
Acme=Acme1(2:85,:);   %making the dim same
n_H=n_H1(2:85,:);
