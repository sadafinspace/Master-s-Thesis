...
%
%    /home/space/Desktop/Sadaf/Events/events/WLRT_2010-04-08_ALL.rt
%
% To extend the code to different selected data or a different text file,
% generate a function instead of a script.

% Auto-generated by MATLAB on 2018/01/09 09:36:19

%% Initialize variables.
filename = '/home/space/Desktop/Sadaf/Events data/events/WLRT_2010-04-08_ALL.rt';
startRow = 2;
...
NGLE = cell2mat(rawNumericColumns(:, 7));
LOSR = cell2mat(rawNumericColumns(:, 8));
ANGE = cell2mat(rawNumericColumns(:, 9));
NBP = cell2mat(rawNumericColumns(:, 10));

%% Clear temporary variables
clearvars filename startRow Date Lon Lat Rot NGLE LOSR ANGE NBP formatSpec fileID dataArray ans raw col numericData rawData row regexstr result numbers invalidThousandsSeparator thousandsRegExp me rawNumericColumns rawCellColumns;
...
m0 = exp(15.4);        %true CME mass
delm = exp(14.7);      %mass increase with height 
hocc = 3.55; %radius of occultation
...
plot(ACC_smooth)
 ...
 %% C_d calculation
Mcme=Mcme1(2:70,:);   %mass of cme
Acme=Acme1(2:70,:);   %making the dim same
n_H=n_H1(2:70,:);
